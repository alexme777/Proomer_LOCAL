 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_View_Helper_CustomRadio extends Zend_View_Helper_FormRadio
{
    /**
     * Input type to use
     * @var string
     ...
     */
    public function customRadio($name, $value = null, $attribs = null, $options = null, $listsep = "<br />\n")
    {
        ...
        foreach ($options as $opt_value => $opt_label) {
            ...
            $radio = '<div class="' . $wrapClass . '"><input type="' . $this->_inputType . '"'
            . ' name="' . $name . '"'
            . ' id="' . $optId . '"'
