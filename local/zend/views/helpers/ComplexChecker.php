 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_View_Helper_ComplexChecker extends Zend_View_Helper_FormElement
{
    /**
     * Input type to use
     * @var string
     ...
     */
    public function complexChecker($name, $value = null, $attribs = null, $options = null, $listsep = "<br />\n") {
